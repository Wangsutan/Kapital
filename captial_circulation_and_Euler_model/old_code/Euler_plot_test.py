...
for i, w in enumerate(w_list):
    ...
    ax.text(1.0, 0.0, 0.0, s="G", zdir="x")
    ax.text(0.0, 1.0, 0.0, s="W", zdir="x")
    ax.text(-1.0, 0.0, 0.0, s="W'", zdir="x")
    ax.text(0.0, -1.0, 0.0, s="G'", zdir="x")
